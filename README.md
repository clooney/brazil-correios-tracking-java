# Brazil Correios Tracking API For Java
Brazil Correios Tracking API and webhook make it easy to integrate Brazil Correios Tracking function into your own project. Support APIs Client Libraries for java

### API key

In order to use this API, you need to generate a Brazil Correios Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Brazil Correios Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Brazil Correios Tracking API](https://www.trackingmore.com/brazil-correios-tracking.html)  to:

   *   Get Brazil Correios realtime tracking info of muti-carriers in one integration
   *   Provide Brazil Correios shipment tracking experience like Amazon
   *   Push Brazil Correios notifications of package update with webhook
   *   Verify Brazil Correios delivery exception before it is too late
